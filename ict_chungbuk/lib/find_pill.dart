...
class FindPill extends StatefulWidget{
  ...
  const FindPill({super.key, required this.title, required this.cameras});

  @override
  State<FindPill> createState() => _FindPill();
}

class _FindPill extends State<FindPill>{
        ...
        Positioned(
          top: size.height*0.04,
            child: TextButton(
              ...
              child: Image.asset('assets/img/back.png', scale: size.width*0.0038,),
            )
        ),
        Center(
          child: Column(
